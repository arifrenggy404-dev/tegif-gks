...
<head>
    ...
    <title>GKS Kanatang | @yield('title', 'Dashboard')</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* sharp bright separator line below brand */
        .brand-separator {
            height: 2px;
        ...
        /* subtle line after each group label */
    ...
    <div class="flex-1 sidebar-scroll overflow-y-auto py-3">
        ...
        <nav class="space-y-0.5">
            <a href="{{ route('admin.jemaat.index') }}"
               class="menu-item {{ request()->routeIs('admin.jemaat.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.pelayan.index') }}"
               class="menu-item {{ request()->routeIs('admin.pelayan.*') ? 'active' : '' }}">
        ...
        <nav class="space-y-0.5">
            <a href="{{ route('admin.jadwal-ibadah.index') }}"
               class="menu-item {{ request()->routeIs('admin.jadwal-ibadah.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.jadwal-pa.index') }}"
               class="menu-item {{ request()->routeIs('admin.jadwal-pa.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.jadwal-kesasi.index') }}"
               class="menu-item {{ request()->routeIs('admin.jadwal-kesasi.*') ? 'active' : '' }}">
        ...
        <nav class="space-y-0.5">
            <a href="{{ route('admin.wartamimbar.index') }}"
               class="menu-item {{ request()->routeIs('admin.wartamimbar.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.asset.index') }}"
               class="menu-item {{ request()->routeIs('admin.asset.*') ? 'active' : '' }}">
                <svg class="menu-icon text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
             ...
             <a href="{{ route('admin.user.index') }}"
                            class="menu-item flex items-center gap-3 px-3 py-3 rounded-xl text-slate-300 hover:text-white text-sm font-bold hover:bg-[#1b442e] hover:translate-x-1 transition-all duration-300">
    ...
    <div class="sidebar-footer">
        <div class="user-chip">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="user-name truncate">{{ Auth::user()->nama ?? 'Admin Web' }}</div>
            </div>
    ...
    <header class="topbar">
        <div style="display:flex;align-items:center;">
            ...
            <div>
                ...
                <div class="topbar-sub">Sistem Informasi Pelayanan Gereja</div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.body.addEventListener('click', function (e) {
        const btn = e.target.closest('.btn-hapus, .btn-hapus-admin');
        if (!btn) return;
        e.preventDefault();

...
<div class="max-w-full overflow-x-hidden px-1 py-2">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        ...
        <div class="flex gap-2 w-full sm:w-auto">
            ...
            <a href="{{ route('admin.jemaat.export-excel') }}"
               class="inline-flex items-center justify-center bg-emerald-700 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-emerald-800 transition shadow-sm flex-1 sm:flex-none text-center">
                 📊 Export Excel
            </a>
        </div>
    </div>
    ...
    <div class="bg-white p-4 rounded-2xl border border-stone-200 mb-5 shadow-sm">
        <form action="{{ route('admin.jemaat.index') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
            ...
            <div class="flex gap-2">
                ...
                @if(request('search'))
                    <a href="{{ route('admin.jemaat.index') }}" class="flex-1 sm:flex-none bg-stone-100 text-stone-600 px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-stone-200 transition border border-stone-300 flex items-center justify-center shadow-sm">
                        Reset
                    </a>
                @endif
            </div>
                ...
                <tr class="block md:table-row bg-white md:bg-transparent border border-stone-200 md:border-none rounded-2xl p-4 shadow-sm md:shadow-none hover:bg-stone-50/50 transition-colors duration-150">
                    ...
                    <td class="flex justify-end md:table-cell px-0 md:px-5 pt-3 md:py-3 text-center">
                        <div class="flex items-center justify-end md:justify-center gap-2 w-full sm:w-auto">
                            <a href="{{ route('admin.jemaat.show', $j) }}"
                            ...
                            <a href="{{ route('admin.jemaat.edit', $j) }}"
                            ...
                            <form action="{{ route('admin.jemaat.destroy', $j) }}"
                                  method="POST"
